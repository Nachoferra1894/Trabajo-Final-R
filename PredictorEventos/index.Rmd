...
# Predecir si una persona va a necesitar circulacion extracorporea
...
subsetForPredictor$`CIRCULACION EXTRACORPOREA`[is.na(subsetForPredictor$`CIRCULACION EXTRACORPOREA`)] <- 0 #Asumo que los que son NA es porque no usaron pump.
...
as.factor(subsetForPredictor$SEXO)

str(subsetForPredictor$`COMPLICACIONES INMEDIATAS`)
...
hyp.out2 <- glm(`COMPLICACIONES INMEDIATAS`~`CIRCULACION EXTRACORPOREA` + EDAD + DIABETES,
