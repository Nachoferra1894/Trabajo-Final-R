...
library(readr)
library(readxl)
datasetCsv <- read_excel("C:\\Users\\nacho\\OneDrive\\Escritorio\\Programacion\\Current\\R\\TP Cardio\\dataset.xlsx")
Data <- datasetCsv
...
<img src="C:\Users\nacho\OneDrive\Escritorio\Rpngs\Ambas.png">
...
The candidates found to have a bigger impact were: `Tiempo de Bomba`, `Complicaciones Inmediatas`, `Complicaciones Tardias`, `vasos Angioplastiados`</p>
...
```{r mediaBomba, echo=FALSE, fig.width= 4.3, fig.height= 4.3}
fig <- plot_ly(data = Data ,y = ~`TIEMPO DE BOMBA`, x = ~`EDAD`, type = "scatter",
        marker = list(size = 5,
                      color = 'rgba(255, 182, 193, .9)',
                      line = list(color = 'rgba(255, 5, 255, .8)',
...
```
<img  class="graphEC" src="C:\Users\nacho\OneDrive\Escritorio\TP R\PredictorEventos\sources\images\Extracorporeal.png" alt="Patients with and without external pumps">

<p class "analysis">Este va al final? </p>
...
```
<p class="analysis">Complications by age</p>
<img src="C:\Users\nacho\OneDrive\Escritorio\Rpngs\ComplicacionesPorEdad.png">
